        ...
        return (
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-xs bg-purple-800/50 hover:bg-purple-700/60 text-purple-200 px-3 py-1.5 rounded-full border border-purple-700/50 transition-colors"
            >
              🗺️ Apri Google Maps
            </a>
          </button>
